...
parser.add_argument('-o', '--output', help='output path for model', default='{}.h5'.format(time.time()))
...
neg_train = neg_train[np.random.choice(len(neg_train), len(pos_train))]
...
# Test Data
pos_test = np.load('F:\\GitHub\\DICOM\\coordinate-07\\0710_60day_20190911_143703SWI\\pos.npy')
...
if args.input:
    ...
    model = get_model(input_shape=(10, 10), output_shape=2, model_type=args.model_type)
